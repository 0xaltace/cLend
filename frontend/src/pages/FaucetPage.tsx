      ...
      <div className="grid md:grid-cols-3 gap-3 text-center text-xs">
        {[
          ...
          <div key={s.n} className="panel p-4">
            <div className="w-7 h-7 rounded-full bg-gradient-to-br from-[#ffd96a] to-[#eaa63c] text-ink font-black grid place-items-center mx-auto mb-2 text-xs shadow-[0_4px_14px_-4px_rgba(247,201,72,0.6)]">
              {s.n}
            </div>
            <div className="font-bold">{s.t}</div>
            <div className="text-t3 mt-0.5">{s.d}</div>
          </div>
        ))}
      </div>
